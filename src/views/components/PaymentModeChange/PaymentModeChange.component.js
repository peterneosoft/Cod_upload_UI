        ...
        GetCODRemittanceDetailsDataTemp(event) {
            ...
            this.$validator.validateAll().then((result) => {
                ...
                if (result) {
                    ...
                    if (this.fromDate) {
                        this.input.FromDate = this.fromDate;
                    }

                    if (this.toDate) {
                        this.input.ToDate = this.toDate;
                    }
                    ...
                    axios({
                            method: 'POST',
                            'url': `${apiUrl.api_url}paymentmodechangereport`,
                            'data': this.input,
                            headers: {
                                'Authorization': 'Bearer ' + this.myStr
                            }
                            ...
                            if (result.data.code == 200) {
                                ...
                                if (this.isexport === true) {
                                    ...
                                    if (result.data.shipmentArr.length > 0) {
                                        ...
                                        this.filename = 'PaymentModeChangeReport';
