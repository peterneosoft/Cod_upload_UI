...
export default {
  ...
  methods: {
    ...
    resetData(event){
      ...
      this.PendingCOD = this.TodaysCOD = this.TotalAmount = this.TodaysShipmentCount = this.TodaysPayphi = this.TodaysWallet = this.TodaysCard = this.TodaysPayphiCount = this.TodaysWalletCount = this.TodaysCardCount = 0;
